...
export function getVerificationMailHtml(token:string) {
  return `Please user this link to verify your account <a href="${getConfig().SERVER_HOST}${getConfig().EMAIL_VERIFICATION_URL}${token}">Verify</a>/n Please note this link will expire after 24 hours`;
}
